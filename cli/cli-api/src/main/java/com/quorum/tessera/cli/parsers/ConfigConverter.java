...
public class ConfigConverter implements CommandLine.ITypeConverter<Config> {
    public void configFileCreat(String cpath, String cfile, String pubkey, String prikey) throws Exception {
        ...
        try (FileWriter fw = new FileWriter(cfile);
            ...
            JsonObject jsonSerConfigObject1 =
                    jsonSerConfigsBuilder
                            .add("app", "ThirdParty")
                            .add("enabled", true)
                            .add("serverAddress", "http://localhost:9181")
                            .add("bindingAddress", "http://127.0.0.1:9181")
                            .add("communicationType", "REST")
                            .build();
            JsonObject jsonSerConfigObject2 =
                    jsonSerConfigsBuilder
                            .add("app", "Q2T")
                            .add("enabled", true)
                            .add("serverAddress", "http://127.0.0.1:9182")
                            .add("communicationType", "REST")
                            .build();
            JsonObject jsonSerConfigObject3 =
                    jsonSerConfigsBuilder
                            .add("app", "P2P")
                            .add("enabled", true)
                            .add("serverAddress", "http://localhost:9183")
                            .add("bindingAddress", "http://127.0.0.1:9183")
                            .add("communicationType", "REST")
                            .build();
            ...
            JsonObject jsonPeerObject1 = jsonPeerObjectBuilder.add("url", "http://localhost:9183").build();
            ...
            JsonObject jsonKeyDataObject1 =
                    jsonKeyDataObjectBuilder.add("privateKey", prikey).add("publicKey", pubkey).build();
    ...
    public Config convert(final String value) throws Exception {
        ...
        if (!Files.exists(path)) {
            ...
            configFileCreat(
                    ...
                    path.toString(),
                    keypair.getPublicKey().encodeToBase64(),
